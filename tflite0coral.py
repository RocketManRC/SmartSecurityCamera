...
# This version uses the Coral TPU
...
model_path = 'ssd_mobilenet_v2_coco_quant_postprocess_edgetpu.tflite' # use the edgetpu compiled model

options = ObjectDetectorOptions(
    num_threads=2,
    score_threshold=0.7,
    max_results=3,
    enable_edgetpu=True) # tell the detector to use the TPU
